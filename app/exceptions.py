"""Custom exception hierarchy for the Keboli Evaluation Agent.
...
class ExternalServiceError(AppError):
    ...
    def __init__(self, service_name: str, message: str = "External service error") -> None:
        super().__init__(
            message=message,
            status_code=502,
...
class EvaluationError(AppError):
    ...
    def __init__(self, session_id: str, message: str = "Evaluation failed") -> None:
        super().__init__(
            message=message,
            status_code=500,
